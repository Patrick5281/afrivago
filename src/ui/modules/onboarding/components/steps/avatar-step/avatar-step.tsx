            ...
            <div className="relative z-10 flex items-center h-full col-span-6 py-10">
              <div className="w-full space-y-5 pb-4.5">
                ...
                <Typography
                  ...
                  theme="gray"
                >
                   C’est sûr, vous avez le profil idéal pour Afrivago !
                    Mais on a besoin de votre plus belle photo
                    pour que les propriétaires puissent vous découvrir comme il se doit.
                    Une photo sympa, c’est la garantie d’inspirer confiance
                    et de vous démarquer lors de vos prochaines réservations.
                    Alors, montrez-nous votre plus beau sourire et trouvez le logement parfait !
                </Typography>
              </div>
            </div>
